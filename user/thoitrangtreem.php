...
?>
	...
	<section>
		<div class="title-new-product">
				...
				<div class="left-new-product">
					<a href="../user/listProduct.php?fashion=TTRE">Xem tất cả</a>
				</div>
			</div>
			<div class="row">
				<?php
					$sql = "SELECT * FROM products WHERE fashionID = 'TTTE'  AND active <> 0 ORDER BY RAND() LIMIT 4 ";
		...
		<div class="title-new-product">
				...
				<div class="left-new-product">
					<a href="../user/listProduct.php?fashion=TTTE">Xem tất cả</a>
				</div>
			</div>
			<div class="row">
				<?php
					$sql = "SELECT * FROM products WHERE fashionID = 'TTTE' AND sale <> 0 AND active <> 0 ORDER BY RAND() LIMIT 4";
