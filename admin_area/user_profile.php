...
?>
   ...
   if (isset($_GET['user_profile'])) {
      ...
      $user_id = urldecode($row_user['admin_id']);

      $user_name = urldecode($row_user['admin_name']);

      $user_pass = urldecode($row_user['admin_pass']);

      $user_email = urldecode($row_user['admin_email']);

      $user_image = urldecode($row_user['admin_image']);

      $user_country = urldecode($row_user['admin_country']);

      $user_about = urldecode($row_user['admin_about']);

      $user_contact = urldecode($row_user['admin_contact']);

      $user_job = urldecode($row_user['admin_job']);
   }
