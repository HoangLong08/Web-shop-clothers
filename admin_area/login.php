...
<body>
   <div class="container">
      <form action="" class="form-login" method="post">
         ...
         <input type="text" class="form-control" placeholder="User name" name="admin_user" required>
...
if (isset($_POST['admin_login'])) {
   ...
   $get_admin = "select * from account_admin where userAdmin='$admin_user' AND password ='$admin_pass'";
